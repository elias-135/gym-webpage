...
def lambda_handler(event, context):
    ...
    for item in data:
       ...
       item['membership_name_str'] = item.pop('membership_name')
       item['membership_id_str'] = item.pop('membership_id')
    ...
    return_me={"membership_item_arr": data}
